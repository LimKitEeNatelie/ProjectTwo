		...
		public static void printCustomer() {
			...
			public static void printTicketList() {
				...
				public static void printPriceList() {
					...
					int[] price = {34, 29, 31, 39, 32, 30, 33, 37};
					print(price);
					
				System.out.println("These are the list of price base on the routes: ");
				
						System.out.println("1.(BC-PS) = RM " + price[0]);
						System.out.println("2.(TM-PK) = RM " + price[1]);
						System.out.println("3.(PR-BM) = RM " + price[2]);
						System.out.println("4.(BW-PB) = RM " + price[3]);
						System.out.println("5.(PS-BC) = RM " + price[4]);
						System.out.println("6.(PK-TM) = RM " + price[5]);
						System.out.println("7.(BM-PR) = RM " + price[6]);
						System.out.println("8.(PB-BW) = RM " + price[7]);
						System.out.println();
				...
				public static void printBuy() {
					...
					int routes, quantity, price;
					routes = in.nextInt();
					
					if (routes == 1) {
						System.out.println("You are choosing: (BC-PS) RM 35");
						System.out.println();
						
					}else if (routes == 2) {
						System.out.println("You are choosing: (TM-PK) RM 30");
						System.out.println();
						
					}else if (routes == 3) {
						System.out.println("You are choosing: (PR-BM) RM 32");
						System.out.println();
						
					}else if (routes == 4) {
						System.out.println("You are choosing: (BW-PB) RM 40");
						System.out.println();
						
					}else if (routes == 5) {
						System.out.println("You are choosing: (PS-BC) RM 33");
						System.out.println();
						
					}else if (routes == 6) {
						System.out.println("You are choosing: (PK-TM) RM 31");
						System.out.println();
						
					}else if (routes == 7) {
						System.out.println("You are choosing: (BM-PR) RM 34");
						System.out.println();
						
					}else if (routes == 8) {
						System.out.println("You are choosing: (PB-BW) RM 38");
						System.out.println();
					...
					System.out.println();
					System.out.println("Enter the price for one ticket that you choose: ");
					price = in.nextInt();
					System.out.println("Price base on the quantity that you choose: RM " + (quantity * price));
